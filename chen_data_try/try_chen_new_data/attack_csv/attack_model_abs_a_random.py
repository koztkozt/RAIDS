...
csv_file = "interpolated_2188to16447_test_4280.csv"
...
for folder in all_folders:
    ...
    csv_input.to_csv(os.path.join(folder, 'interpolated_2188to16447_test_4280_attack_a_0p15_0p7.csv'), index = False)
