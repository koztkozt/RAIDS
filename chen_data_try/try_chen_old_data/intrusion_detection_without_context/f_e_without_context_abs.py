...
if __name__ == "__main__":
    ...
    # face_dataset = intrusion_data(csv_file='interpolated_random_a_0p25_1_10702to24371_part1_9569.csv', root_dir='./data', cs=1,
    #                             transform=transforms.Compose(
    #                                 [transforms.Resize(256),
    #                                 transforms.RandomResizedCrop(224),
    #                                 transforms.ToTensor()]))

    # test_dataset = intrusion_data(csv_file='interpolated_random_a_0p25_1_10702to24371_part1_4103.csv', root_dir='./data', cs=1,
    #                             transform=transforms.Compose(
    #                                 [transforms.Resize(256),
    #                                 transforms.RandomResizedCrop(224),
    #                                 transforms.ToTensor()]))
